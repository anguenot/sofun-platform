 ...
 */
@Entity
@Table(name = "predictions_ordered_contestants_stages")
@Inheritance(strategy = InheritanceType.JOINED)
public class PredictionStageOrderedContestantsListImpl extends PredictionOrderedContestantsListImpl implements
        PredictionStageOrderedContestantsList {

    private static final long serialVersionUID = 835025690988919144L;

    @ManyToOne(targetEntity = TournamentStageImpl.class, fetch = FetchType.EAGER)
